...
using CheesePersistence.ViewModels;

namespace CheesePersistence.Controllers
{
    public class MenuController : Controller
    {
        ...
        {
            AddMenuViewModel addMenuViewModel = new AddMenuViewModel(context.Menus.ToList()); //right?
